...
trajectory = deque(maxlen=50)       # Stores pixel positions
...
def start_recording():
    ...
    video_writer = cv2.VideoWriter(output_filename, fourcc, 30.0, (1280, 480))
    recording = True
...
def stop_recording():
    ...
    if video_writer is not None:
        ...
        print(f"Stopped recording. Saved as: {output_filename}")
    video_writer = None
    recording = False
